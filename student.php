...
<div class="container mt-4">
    ...
    $sql = "SELECT std_id, std_name, std_lname, std_prov, salary FROM student";
        ...
        <table class="table table-striped">
            ...
            ?>
                <td>
                    ...
                    href="edit_form_data.php?edit_id=<?php echo $row['std_id']; ?>">Edit</a>
                </td>
                <td>
                    <a class="btn btn-danger"
                    href="delete_student.php?del_id=<?php echo $row['std_id']; ?>"
                    onclick="return confirm('คุณต้องการลบนักศึกษา ID=<?php echo $row['std_id']; ?> ?');">Delete</a>
                </td>
            <?php
                echo "</tr>";
            }
